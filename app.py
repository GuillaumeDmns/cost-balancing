...
people_menu.add_command(label="Ajouter")
people_menu.add_command(label="Modifier")
people_menu.add_command(label="Supprimer")
menu_bar.add_cascade(label="People", menu=people_menu)

expense_menu = Menu(menu_bar, tearoff=0)
expense_menu.add_command(label="Ajouter")
expense_menu.add_command(label="Modifier")
expense_menu.add_command(label="Supprimer")
